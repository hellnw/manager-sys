...
public class ${className}Controller extends BaseController {
    ...
    @GetMapping(SysConstant.VIEW_PREFIX + "${className?uncap_first}")
    public String ${className?uncap_first}Index(){
        return SysUtil.view("${className?uncap_first}/${className?uncap_first}");
    }

    @GetMapping("${className?uncap_first}")
    @ResponseBody
    @RequiresPermissions("${className?uncap_first}:list")
    public SysResponse getAll${className}s(${className} ${className?uncap_first}) {
        return new SysResponse().success().data(${className?uncap_first}Service.find${className}s(${className?uncap_first}));
    }

    @GetMapping("${className?uncap_first}/list")
    @ResponseBody
    @RequiresPermissions("${className?uncap_first}:list")
    public SysResponse ${className?uncap_first}List(QueryRequest request, ${className} ${className?uncap_first}) {
    ...
    public SysResponse add${className}(@Valid ${className} ${className?uncap_first}) {
    ...
    public SysResponse delete${className}(${className} ${className?uncap_first}) {
    ...
    public SysResponse update${className}(${className} ${className?uncap_first}) {

package com.sbs.monitor.service.impl;
...
import com.sbs.common.utils.HttpContextUtil;
import com.sbs.common.utils.IPUtil;
import com.sbs.common.utils.SortUtil;
import com.sbs.monitor.entity.LoginLog;
import com.sbs.monitor.mapper.LoginLogMapper;
...
public class LoginLogServiceImpl extends ServiceImpl<LoginLogMapper, LoginLog> implements ILoginLogService {
    ...
    public IPage<LoginLog> findLoginLogs(LoginLog loginLog, QueryRequest request) {
        ...
        SortUtil.handlePageSort(request, page, "loginTime", SysConstant.ORDER_DESC, true);

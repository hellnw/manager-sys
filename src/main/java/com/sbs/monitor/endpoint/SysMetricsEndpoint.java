...
@SysEndPoint
public class SysMetricsEndpoint {

    private final MeterRegistry registry;

    public SysMetricsEndpoint(MeterRegistry registry) {
    ...
    @ReadOperation
    public SysMetricResponse metric(@Selector String requiredMetricName, @Nullable List<String> tag) {
        ...
        if (meters.isEmpty()) {
            ...
            return new SysMetricResponse(requiredMetricName, meterId.getDescription(), meterId.getBaseUnit(), this.asList(samples, Sample::new), this.asList(availableTags, AvailableTag::new));
        }
    }
    ...
    public static final class SysMetricResponse {
        ...
        SysMetricResponse(String name, String description, String baseUnit, List<Sample> measurements, List<AvailableTag> availableTags) {
            this.name = name;

...
import com.sbs.common.authentication.ShiroRealm;
...
import com.sbs.system.entity.UserRole;
import com.sbs.system.mapper.UserMapper;
import com.sbs.system.service.IUserRoleService;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements IUserService {
    ...
    public void updateUser(User user) {
        ...
        User currentUser = SysUtil.getCurrentUser();
    ...
    public void regist(String username, String password) {
        ...
        ur.setRoleId(SysConstant.REGISTER_ROLE_ID);
    ...
    public void updateProfile(User user) {
        ...
        if (isCurrentUser(user.getId())) {
            ...
            throw new SysException("您无权修改别人的账号信息！");
        }
    }
